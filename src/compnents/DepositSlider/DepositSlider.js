...
const DepositSlider = ({ depositType, closeDepositModal }) => {
    ...
    return (
        <>
            <div onClick={CloseToIcon} className="flex justify-end items-center z-50 top-0 w-full h-[100vh] md:h-full fixed bg-[#000] bg-opacity-[30%]" id='scroll'>
                <animated.div style={animation} className="font-Rajdhani">
                    {depositType == 1 ?
                        <div onClick={handleClickEvent} className='relative flex flex-col md:justify-evenly w-screen lg:w-[27vw] h-screen overflow-y-scroll pt-[12px] pb-[1vh] px-[12px] lg:pl-[0.8vw] lg:pr-[0.5vw] lg:py-[1vh] md:px-[60px] bg-[#fff] lg:rounded-l-[20px] font-montserrat bg-[url("../src/assets/images/deposit_slider_back.png")] bg-no-repeat bg-bottom bg-[length:100%_38vh]'>
                            ...
                            <div className='px-[1.5vw] mt-[10px]'>
                                <div className='bg-[#fff] bg-opacity-[30%] w-full rounded-[10px] shadow-[0px_0px_34px_rgba(0,0,0,0.15)] py-[6px] px-[14px] lg:py-[1vh] lg:px-[0.8vw] text-[#595A5B] text-[1.8vh] lg:text-[0.6vw] font-[500] leading-[2vh] text-left space-y-[1vh] lg:font-montserrat font-Rajdhani'>
                                    <div className='flex'>
                                        <p className='mr-[8px] text-[20px] mb-[0] lg:pt-[7px] pt-[5px]'><svg style={{width:'5px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#555555" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512z"/></svg></p>
