                                ...
                                <div className="main-container">
                                    <div className="flex flex-col justify-between lg:h-[93vh] dashboard-container">
                                        ...
                                        <div className='lg:flex flex-col space-y-[1vh] h-full w-full lg:w-[68vw] mt-[2vh] relative bg-[#FFFFFF] bg-opacity-[60%] rounded-[20px] px-[20px] py-[20px] lg:pt-[4vh] lg:pl-[2vw]  lg:pb-[4vh] lg:pr-[3vw] shadow-[0px_0px_44px_rgba(0,0,0,0.1)] font-Rajdhani lg:font-montserrat text-[0.7vw] text-[#595A5B]'>
                                            ...
                                            <p className='mb-[0]'>Our company was founded in 2017 during the original mining boom and rapid private mining farms development.<br />
            Regular mining requires certain knowledge and know-how and large starting investments, so it was pretty hard for ordinary people to get involved in the industry. However, our founders saw an opportunity to democratize mining and make it accessible to everyone. That's why they came up with the idea of creating a user-friendly platform that would allow anyone to start mining cryptocurrency with ease.<br /><br />
            At our company, we believe in investing in the future. That's why we conduct extensive research into emerging technologies and promising startups, seeking out the most innovative and impactful ideas to support. We also take our responsibility to the planet seriously and prioritize environmental sustainability in all of our operations. Additionally, we place a high value on security and take every measure to ensure the safety of our customers' assets and data.<br /><br />
                                    ...
                                    <div className="flex flex-col justify-between lg:h-[93vh] dashboard-container">
                                        ...
                                        <div itemscope="" itemtype="https://schema.org/Organization" className='lg:flex flex-col h-full w-full lg:w-[68vw] mt-[2vh] relative bg-[#FFFFFF] bg-opacity-[60%] rounded-[20px] px-[20px] py-[20px] lg:pt-[4vh] lg:pl-[2vw] lg:pb-[4vh] lg:pr-[3vw] shadow-[0px_0px_44px_rgba(0,0,0,0.1)] font-Rajdhani lg:font-montserrat text-[0.7vw] text-[#595A5B]'>
                                            <div className='flex flex-col space-y-[2vh] leading-[24px] lg:leading-[3vh] overflow-y-scroll h-[312px] lg:h-full text-[19px] lg:text-[0.7vw]'>
                                                ...
                                                <p className='mb-[0]' itemprop='description'>Our company was founded in 2017 during the original mining boom and rapid private mining farms development.<br />
            Regular mining requires certain knowledge and know-how and large starting investments, so it was pretty hard for ordinary people to get involved in the industry. However, our founders saw an opportunity to democratize mining and make it accessible to everyone. That's why they came up with the idea of creating a user-friendly platform that would allow anyone to start mining cryptocurrency with ease.<br /><br />
            At our company, we believe in investing in the future. That's why we conduct extensive research into emerging technologies and promising startups, seeking out the most innovative and impactful ideas to support. We also take our responsibility to the planet seriously and prioritize environmental sustainability in all of our operations. Additionally, we place a high value on security and take every measure to ensure the safety of our customers' assets and data.<br /><br />
