            ...
            <div className="flex justify-between mx-[1.5vw] mt-[1vh]">
                ...
                <div className="hidden sm:block pr-[5vw] pl-[1vw] w-[45%] font-montserrat">
                    ...
                    <div className='mt-[8vh]'>
                        <button type='button' className='flex items-center border-[#429763] hover:bg-opacity-70 border-[2px] transition duration-300 px-[2vw] py-[0.8vh] sm:text-[24px] text-[16px] bg-[#449552] text-[#fff] rounded-[10px] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]' onClick={openModal}>Sign Up<span>
